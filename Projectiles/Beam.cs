...
namespace Acceleration.Projectiles
{
	class Beam : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			AccelerationHelper.DrawSprite("Acceleration/Projectiles/Beam", Projectile.Center, 0, 16, Color.White, Projectile.rotation, new Vector2(1,1), Main.spriteBatch);
			return false;
		}
