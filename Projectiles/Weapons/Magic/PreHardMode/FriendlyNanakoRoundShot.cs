...
{
	internal class FriendlyNanakoRoundShot : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.rand.NextFloat() < 0.15)
			{
				...
				dust = Main.dust[Terraria.Dust.NewDust(position, 30, 30, 43, 0f, 0f, 0, new Color(255, 128, 255), 0.4069768f)];
			}
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			for (int i = 0; i < 20; ++i)
			{
				Dust dust = Main.dust[Terraria.Dust.NewDust(position, 30, 30, 43, 0f, 0f, 0, new Color(255, 128, 255), 0.4069768f)];
			}
			return true;
		}
